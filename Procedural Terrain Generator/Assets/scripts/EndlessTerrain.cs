...
public class EndlessTerrain : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        meshWorldSize = mapGenerator.meshSettings.meshWorldSize; //actual mesh size is 1 less than the variable
    ...
    public class TerrainChunk
    {
        ...
        public TerrainChunk(Vector2 coord, float meshWorldSize, LODInfo[] detailLevels, int colliderLODIndex, Transform parent, Material material)
        {
            ...
            sampleCentre = coord * meshWorldSize / mapGenerator.meshSettings.meshScale; //dividing because it shouldn't be affected by mesh scale
        ...
        public void UpdateTerrainChunk()
        {
            if (mapDataReceived)
            {
                ...
                if (visible)
                {
                    ...
                    for (int i = 0; i < detailLevels.Length - 1; i++) //dont need the last in the array because it should always be false
                    {
        ...
        public void UpdateCollisionMesh() 
        {
            if (!hasSetCollider)
            {
                ...
                if (sqrDstFromViewerToEdge < detailLevels[colliderLODIndex].sqrVisibleDstThreshold) //to ensure the mesh has a collider
                {
                ...
                if (sqrDstFromViewerToEdge < colliderGenerationDistanceThreshold * colliderGenerationDistanceThreshold) //has to be squared because the bounds are squared
                {
                    if (lodMeshes[colliderLODIndex].hasMesh)
                    {
